...
export const ScreenSpareCard: React.FC<ScreenSpareCardProps> = ({
  ...
  return (
    <div className="group bg-slate-900 border border-slate-800 rounded-2xl overflow-hidden hover:border-slate-700 transition-all flex flex-col justify-between">
      
      {/* Visual Header */}
      <div className="relative aspect-video w-full bg-slate-950 p-4 flex items-center justify-center overflow-hidden">
        {/* Quality Grade Badge */}
        <span
        ...
        {/* Frame Status Pill */}
        <span className="absolute top-3 right-3 z-10 px-2.5 py-1 rounded-md text-[11px] font-semibold bg-slate-800/90 text-slate-300 border border-slate-700">
      ...
      <div className="p-4 flex-1 flex flex-col justify-between space-y-3">
        <div>
          ...
          <h3 className="font-bold text-slate-100 text-sm line-clamp-2">{spare.title}</h3>
        ...
        <div className="space-y-1.5 pt-2 border-t border-slate-800/80 text-xs text-slate-400">
          <div className="flex justify-between">
            ...
            <span className="text-slate-200 font-medium">{spare.displayTech}</span>
          </div>
          <div className="flex justify-between">
            <span>Warranty:</span>
        ...
        <div className="pt-3 border-t border-slate-800/80">
          ...
          <div className="grid grid-cols-2 gap-2">
            <button
              ...
              className="py-2 px-2.5 rounded-lg text-xs font-semibold bg-slate-800 hover:bg-slate-700 text-slate-200 border border-slate-700 transition"
            >
              Check Fit
            </button>
            <button
