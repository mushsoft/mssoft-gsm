  ...
  return (
    ...
    >
      ...
      <motion.p variants={item} className="mt-3 text-sm text-neutral-500 dark:text-neutral-400 sm:text-base">
        Screens, batteries, testpoint diagrams, flashing tools and phones &mdash; instant checkout
        or order straight to WhatsApp.
      </motion.p>
